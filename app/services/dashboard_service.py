...
def _quick_sentiment(news_items: List[NewsItem]) -> Dict[str, float]:
    """Lightweight keyword sentiment scoring to avoid LLM dependency."""
    positive_keywords = {
        "upgrade",
        "beat",
        "surpass",
...
class DashboardService:
    ...
    def _analyze_news(self, news_items: List[NewsItem]) -> AgentScore:
        ...
        sentiment_metrics = _quick_sentiment(news_items)
